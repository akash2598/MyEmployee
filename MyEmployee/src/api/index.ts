...
export const API = {
  getEmployee: (responsecallback: any) => {
    request(responsecallback, {}, 'GET', URL + 'employees', buildHeader());
  },
  ...
  AddEmployee: (responsecallback: any, data: any) => {
    request(responsecallback, data, 'POST', URL + 'create', buildHeader());
  },
  UpdateEmployee: (responsecallback: any, data: any, id: string) => {
    request(responsecallback, data, 'PUT', URL + `update/${id}`, buildHeader());
  },
};
